...
/**
 * Configuration for Profile Service primary database (profile_service_db).
 * Manages ProfileEntity.
 */
@Configuration
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = "com.restaurant.profileservice.repository", entityManagerFactoryRef = "profileEntityManagerFactory", transactionManagerRef = "profileTransactionManager")
public class ProfileDbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean profileEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.restaurant.profileservice.entity")
